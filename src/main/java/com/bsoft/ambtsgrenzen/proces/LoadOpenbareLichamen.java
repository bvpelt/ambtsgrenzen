...
import com.bsoft.ambtsgrenzen.model.OpenbaarLichaam;
import com.bsoft.ambtsgrenzen.model.OpenbareLichamenResponse;
...
public class LoadOpenbareLichamen {
    ...
    private long getNextPage(String url) {
        ...
        if (response != null) {
            ...
            for (i = 0; i < openbareLichamen.length; i++) {
                ...
                OpenbaarLichaam ol = new OpenbaarLichaam();
    ...
    */
    @Transactional
    public long persistOpenbaarLichaam(OpenbaarLichaam openbaarLichaam) {
        OpenbaarLichaam ol = null;
        long result = 0L;
        Optional<OpenbaarLichaam> existingOpenbaarLichaam = openbaarLichaamRepository.findByCode(openbaarLichaam.getCode());
        ...
        if (existingOpenbaarLichaam.isEmpty()) {
            ...
            OpenbaarLichaam exOl = existingOpenbaarLichaam.get();
